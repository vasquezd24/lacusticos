...
import com.dva.lacustico.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.dva.lacustico.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoryResource {
    ...
    @GetMapping("/categories/categoryByPro")
    public List <Category> getCategoryByTypePro(){
        return  categoryRepository.findByTypeProd();
    }

    @GetMapping("/categories/categoryByEnt")
    public List <Category> getCategoryByTypeEnt(){
        return  categoryRepository.findByTypeEnt();
    }
