package com.dva.lacustico.config;

import com.dva.lacustico.security.*;
import com.dva.lacustico.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/entrepreneurs/**").permitAll()
            .antMatchers("/api/locations/**").permitAll()
            .antMatchers("/api/delivery-platforms/**").permitAll()
            .antMatchers("/api/subscriptors").permitAll()
            .antMatchers("/api/subscriptors/**").permitAll()
